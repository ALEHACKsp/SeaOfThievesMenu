...
namespace SotMLauncher
{
    public static class ProcessUtils
    {
        ...
        public static IntPtr GetModuleBase(IntPtr procHandle, string targetModuleName)
        {
            ...
            bool enumProcessResult = WinAPI.EnumProcessModulesEx(procHandle, pModules, uiSize, out uint cbNeeded, (uint)WinAPI.EnumProcessModulesFilterFlag.LIST_MODULES_ALL);
