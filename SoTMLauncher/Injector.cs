...
namespace SotMLauncher
{
    public static class Injector
    {
        public static bool Inject(Process targetProcess, string fullPathToDLL, System.Windows.Forms.RichTextBox rtxtLog = null)
        {
            ...
            IntPtr procHandle = WinAPI.OpenProcess((uint)(WinAPI.ProcessAccessFlags.CreateThread | 
                ...
                WinAPI.ProcessAccessFlags.VirtualMemoryRead), 0, (uint)targetProcess.Id);
            ...
            IntPtr allocMemAddress = WinAPI.VirtualAllocEx(procHandle, 
                (IntPtr)null, 
                (IntPtr)fullPathToDLL.Length + 1, 
                (uint)(WinAPI.AllocationType.Reserve | WinAPI.AllocationType.Commit), (uint)WinAPI.MemoryProtection.ExecuteReadWrite
                );
            ...
            WinAPI.WriteProcessMemory(procHandle, allocMemAddress, bytes, (uint)bytes.Length, out IntPtr bytesWritten);
...
#pragma warning restore IDE0018 // Inline variable declaration
                ...
                {
                    Logger.Log.WriteError($"Could not get exit code from remote thread: {  Marshal.GetLastWin32Error() }", rtxtLog);
                    WinAPI.VirtualFreeEx(procHandle, allocMemAddress, (IntPtr)0, (uint)WinAPI.AllocationType.Release);
